...
async def send_montage(message: types.Message):
    ...
    kb = InlineKeyboardBuilder()
    kb.button(text="📥 CapCut (Yuklab olish)", url="https://play.google.com/store/apps/details?id=com.lemon.lvoverseas")
    kb.button(text="📥 InShot (Yuklab olish)", url="https://play.google.com/store/apps/details?id=com.camerasideas.instashot")
...
async def h_insta(message: types.Message):
    # Instander saytiga yo'naltiramiz (Eng ishonchli mod)
...
async def h_spotify(message: types.Message):
    # Spotify XManager (Eng zo'r mod menejeri)
...
async def h_inshot(message: types.Message):
    await message.answer("InShot Pro versiyasini yuklab olish:", reply_markup=link_btn("InShot Pro", "https://play.google.com/store/apps/details?id=com.camerasideas.instashot"))

@dp.message(F.text == "VPN Pro versiya 🌐")
async def h_vpn(message: types.Message):
    await message.answer("AdGuard VPN (Tezkor va xavfsiz):", reply_markup=link_btn("VPN", "https://adguard-vpn.com/en/welcome.html"))
